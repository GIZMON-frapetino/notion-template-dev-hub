...
- URL: https://gizmon-frapetino.github.io/notion-template-dev-hub/

## Product specs

- [T-03 案件・クライアントCRM — 仕様](specs/T-03-client-crm/specification.md)
- [T-03 案件・クライアントCRM — 運用方法](specs/T-03-client-crm/operations.md)
- [T-03 案件・クライアントCRM — API連携仕様](specs/T-03-client-crm/api-integration.md)
